...
from .protocols.protocol_protenix import ProtenixProtocol
...
class ChimeraProtenix(Viewer):
    _label = 'viewer alphafold'
    _targets = [ProtenixProtocol]
    ...
    def _visualize(self, obj, **args):
        ...
        if self.protocol.source == self.protocol.IMPORT_ZIP_ALPHAFOLD3:
          f.write("ui tool show Matchmaker\n")
          f.write("matchmaker #3-6 to #2\n\n")
        f.close()
